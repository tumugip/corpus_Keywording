...
def yougo(file):
  ...
  keyword_df= keyword_df.reset_index(drop=True)
  new_path = args.file_path.replace('.jsonl','')
  keyword_df.to_json(new_path+'_yougo.jsonl', orient='records', force_ascii=False, lines=True)
...
def saisyou(file):
  ...
  keyword_df= keyword_df.reset_index(drop=True)
  new_path = args.file_path.replace('.jsonl','')
  keyword_df.to_json(new_path+'_saisyou.jsonl', orient='records', force_ascii=False, lines=True)
